...
error["time_future240"] = error["time"].apply(lambda x: x + relativedelta(hours= 4))
error["time_last240"] = error["time"].apply(lambda x: x - relativedelta(hours= 4))
error["time_future241"] = error["time"].apply(lambda x: x + relativedelta(hours= 12))
error["time_last241"] = error["time"].apply(lambda x: x - relativedelta(hours= 12))
error["time_future242"] = error["time"].apply(lambda x: x + relativedelta(days=1))
error["time_last242"] = error["time"].apply(lambda x: x - relativedelta(days=1))
error["time_future243"] = error["time"].apply(lambda x: x + relativedelta(days=4))
error["time_last243"] = error["time"].apply(lambda x: x - relativedelta(days=4))
...
del error["time_last241"]
del error["time_last242"]
del error["time_last243"]
del error["time_future240"]
del error["time_future241"]
del error["time_future242"]
del error["time_future243"]
error.to_csv(out+"datafusai_all0905_nodrop.csv",index=False)